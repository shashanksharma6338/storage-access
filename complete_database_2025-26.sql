...
-- Complete Database Setup Script for Register Management System (2025-26)
-- This script creates all necessary tables and inserts 10 dummy entries for each register
...
SELECT 'Supply Orders' as Register, COUNT(*) as Total_Entries FROM supply_orders WHERE financial_year = '2025-2026'
UNION ALL
SELECT 'Demand Orders' as Register, COUNT(*) as Total_Entries FROM demand_orders WHERE financial_year = '2025-2026'
UNION ALL
SELECT 'Bill Orders' as Register, COUNT(*) as Total_Entries FROM bill_orders WHERE financial_year = '2025-2026'
UNION ALL
SELECT 'Sanction Gen Project' as Register, COUNT(*) as Total_Entries FROM sanction_gen_project WHERE financial_year = '2025-2026'
UNION ALL
SELECT 'Sanction Misc' as Register, COUNT(*) as Total_Entries FROM sanction_misc WHERE financial_year = '2025-2026'
UNION ALL
SELECT 'Sanction Training' as Register, COUNT(*) as Total_Entries FROM sanction_training WHERE financial_year = '2025-2026';
